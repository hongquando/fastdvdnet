...
def main(**args):
	...
	container_files = os.listdir(args['trainset_dir'])
	loader_train = [args['trainset_dir'] + '/' + f for f in container_files]
	for i in range(args['repeat_data']-1):
		loader_train.append(loader_train[0])
...
if __name__ == "__main__":
	...
	parser.add_argument("--repeat_data", type=int, default=25, \
						help='repeat the data x times for the training process')
